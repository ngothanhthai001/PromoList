...
class Toolbar extends Template
{
    ...
    {
        $limit = $this->_getData('promolist_current_limit');
        if ($limit) {
            return $limit;
        }
        ...
        $this->setData('promolist_current_limit', $limit);
    ...
    {
        $order = $this->_getData('promolist_current_order');
        if ($order) {
            return $order;
        }
        ...
        $this->setData('promolist_current_order', $order);
    ...
    {
        $dir = $this->_getData('promolist_current_direction');
        if ($dir) {
            return $dir;
        }
        ...
        $this->setData('promolist_current_direction', $dir);

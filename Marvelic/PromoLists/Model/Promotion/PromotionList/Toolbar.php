...
namespace Marvelic\PromoLists\Model\Promotion\PromotionList;
...
class Toolbar
{
     ...
     */
    const ORDER_PARAM_NAME = 'promotion_list_order';

    /**
     * Sort direction cookie name
     */
    const DIRECTION_PARAM_NAME = 'promotion_list_dir';

    /**
     * Sort mode cookie name
     */
    const MODE_PARAM_NAME = 'promotion_list_mode';
